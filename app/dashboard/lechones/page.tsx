...
function createData(
  ...
  return { Idcamada, FechaNac, Madre, Padre, lechones, peso, mortalidad, estados };
}
...
const initialRows = [createData("Frozen yoghurt", new Date(), 6.0,3, 24, 4.0, 78, "Activo")];
        ...
        <div className="bg-white rounded-xl shadow-xl/20 inset-shadow-sm p-6 mb-8">
          ...
          <TableContainer className="mt-3 " component={Paper}>
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
              ...
              <TableBody>
                {rows.map((row, index) => (
                  <StyledTableRow key={row.Idcamada}>
                    ...
                    <StyledTableCell align="right">
                      ...
                      <IconButton onClick={() => handleDelete(row.Idcamada)} aria-label="delete" size="small">
